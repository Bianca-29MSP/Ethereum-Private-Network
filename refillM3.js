...
// Configurações
const minerName = 'miner3';
const minerUrl = 'http://localhost:8547';
const masterAccount = '0xc5803Ca9b9Ff136855C287b1515D5565139926d3'; // Conta com fundos
...
// Observação: Miner3 só tem a master account com saldo, as demais contas têm saldo zero
const accountsMiner3 = [
...
async function refillAllAccounts() {
  try {
    ...
    const accountsEstimate = accountsMiner3.length - 1; // Menos a própria master
    ...
    console.log(`🔍 ${accountsMiner3.length} contas configuradas para este minerador`);
    
    // Filtra a lista para remover a master account
    const accountsToRefill = accountsMiner3.filter(acc => 
