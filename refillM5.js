...
// Configurações
const minerName = 'miner5';
const minerUrl = 'http://localhost:8549';
const masterAccount = '0x06fd657C34e3213d3a8de5dfb4033b369F2Bd0Fb'; // Conta com fundos
...
// Observação: Miner5 só tem a master account com saldo, as demais contas têm saldo zero
const accountsMiner5 = [
...
async function refillAllAccounts() {
  try {
    ...
    const accountsEstimate = accountsMiner5.length - 1; // Menos a própria master
    ...
    console.log(`🔍 ${accountsMiner5.length} contas configuradas para este minerador`);
    
    // Filtra a lista para remover a master account
    const accountsToRefill = accountsMiner5.filter(acc => 
