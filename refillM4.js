...
// Configurações
const minerName = 'miner4';
const minerUrl = 'http://localhost:8548';
const masterAccount = '0x9DA6D31B1b600e0e3c66f1D063F3464eeF8f2a82'; // Conta com fundos
...
// Observação: Miner4 só tem a master account com saldo, as demais contas têm saldo zero
const accountsMiner4 = [
...
async function refillAllAccounts() {
  try {
    ...
    const accountsEstimate = accountsMiner4.length - 1; // Menos a própria master
    ...
    console.log(`🔍 ${accountsMiner4.length} contas configuradas para este minerador`);
    
    // Filtra a lista para remover a master account
    const accountsToRefill = accountsMiner4.filter(acc => 
